...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/overturemaps-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/overturemaps-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add overturemaps
# for installing globally
pixi global install overturemaps
```
...
It is possible to list all of the versions of `overturemaps` available on your platform:
...
```
pixi search overturemaps --channel conda-forge
```
